 ...
 */
final class Version20210218191424 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE abonnement (id INT AUTO_INCREMENT NOT NULL, name LONGTEXT DEFAULT NULL, price DOUBLE PRECISION DEFAULT NULL, perle INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, duration INT DEFAULT NULL, access LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE utilisateur (id INT AUTO_INCREMENT NOT NULL, departement_id INT DEFAULT NULL, region_id INT DEFAULT NULL, pays_id INT DEFAULT NULL, username VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, genre TINYINT(1) DEFAULT NULL, je_cherche LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', date_naissance DATETIME DEFAULT NULL, description VARCHAR(255) DEFAULT NULL, age INT DEFAULT NULL, couleur_de_cheveux LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', degaine LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', sexualite LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', taille INT DEFAULT NULL, style_de_cheveux LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', silouhette LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', j_ai_un_faible_pour LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', poids INT DEFAULT NULL, couleur_des_yeux VARCHAR(255) DEFAULT NULL, origines LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', j_aime_porter_ou_pas LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', je_frissone_pour LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', passions_au_lit VARCHAR(255) DEFAULT NULL, proffessions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', sports LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', hobbies LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', alcool LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', tabac LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', alimentation LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', j_aime_manger LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', scolarite LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', langues LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', signe_astrologique LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', avec_ou_sans_enfant TINYINT(1) DEFAULT NULL, gout_musicaux LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', religions LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', personalite LONGTEXT DEFAULT NULL COMMENT \'(DC2Type:json)\', email VARCHAR(255) DEFAULT NULL, ville VARCHAR(255) DEFAULT NULL, adresse LONGTEXT DEFAULT NULL, certifie TINYINT(1) NOT NULL, condition_generale TINYINT(1) NOT NULL, condition_vente TINYINT(1) NOT NULL, peut_envoyer_mail_depuis_le_site TINYINT(1) NOT NULL, is_online TINYINT(1) DEFAULT NULL, profileimage VARCHAR(255) DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, UNIQUE INDEX UNIQ_1D1C63B3F85E0677 (username), INDEX IDX_1D1C63B3CCF9E01E (departement_id), INDEX IDX_1D1C63B398260155 (region_id), INDEX IDX_1D1C63B3A6E44244 (pays_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
