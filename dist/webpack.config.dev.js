 ...
 */
.addEntry('app', './assets/js/app.js') //.addEntry('page2', './assets/js/page2.js')
...
.enableSassLoader() // uncomment if you use TypeScript
.enableTypeScriptLoader() // uncomment to get integrity="..." attributes on your script & link tags
// requires WebpackEncoreBundle 1.4 or higher
//.enableIntegrityHashes(Encore.isProduction())
// uncomment if you're having problems with a jQuery plugin
//.autoProvidejQuery()
// uncomment if you use API Platform Admin (composer req api-admin)
.enableReactPreset().addEntry('chat', './assets/js/chat.js') //.addEntry('admin', './assets/js/admin.js')
;
